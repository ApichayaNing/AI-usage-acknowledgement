// Keep this lean; adjust behaviour labels with Antony & Miriam
window.APP_CONFIG = {
  behaviours: [
    { id: 'brainstorming', label: 'Idea development (brainstorming/outlining)' },
    { id: 'understanding', label: 'Understanding content (explaining/summarising/translate)' },
    { id: 'polishing', label: 'Language polishing (grammar/rephrase/tone)' },
    { id: 'structuring', label: 'Structure & planning (outlines/checklists)' },
